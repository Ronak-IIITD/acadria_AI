      ...
      <section id="home" className="relative text-center pt-20 pb-16 sm:pt-32 sm:pb-24 lg:pt-40 lg:pb-32 overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 sm:px-8">
          ...
          <ScrollReveal animation="fade" delay={0.3}>
            <p className="mt-10 max-w-3xl mx-auto text-lg sm:text-xl font-medium animate-fade-in-up"
               style={{ 
          ...
          <ScrollReveal animation="scale" delay={0.4}>
            ...
            <button 
              ...
              className="group px-8 py-4 text-base font-semibold rounded-2xl shadow-xl hover:shadow-2xl transition-all transform hover:scale-105 active:scale-98"
              style={{
                background: 'linear-gradient(135deg, #35d0c3 0%, #8b93d4 100%)',
                color: '#FFFFFF',
            ...
            <button 
              className="px-8 py-4 text-base font-semibold rounded-2xl transition-all hover:scale-105 active:scale-98 backdrop-blur-sm"
              style={{
